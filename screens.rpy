...
screen main_menu:
    ...
    frame:
        ...
        textbutton _("Новое начало") action Start()
        textbutton _("Продолжить начатое") action ShowMenu("load")
        textbutton _("Изменить настройки") action ShowMenu("preferences")
        textbutton _("Найти ответы") action Help()
        textbutton _("Вернуться в реальность") action Quit(confirm=False)
...
screen navigation:
    ...
    frame:
        ...
        textbutton _("Изменить настройки") action ShowMenu("preferences")
        textbutton _("Записать память") action ShowMenu("save")
        textbutton _("Исправить ошибки") action ShowMenu("load")
        textbutton _("К началу") action MainMenu()
        textbutton _("Найти ответы") action Help()
        textbutton _("Вернуться в реальность") action Quit()
...
screen file_picker:
    ...
    frame:
        ...
        hbox:
            ...
            textbutton _("Предыдущая"):
                action FilePagePrevious()

            textbutton _("Автосейв"):
                action FilePage("auto")

            textbutton _("Квиксейв"):
...
screen yesno_prompt:
    ...
    frame:
        ...
        hbox:
            ...
            textbutton _("Наверное, да") action yes_action
            textbutton _("Я уверен, что нет") action no_action
...
screen quick_menu:
    ...
    hbox:
        ...
        textbutton _("Отмотать время") action Rollback()
        textbutton _("Записать память") action ShowMenu('save')
        textbutton _("Изменить настройки") action ShowMenu('preferences')
